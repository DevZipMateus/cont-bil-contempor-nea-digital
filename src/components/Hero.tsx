...
export function Hero() {
  ...
  return (
    <section
      id="inicio"
      className="relative min-h-[160vh] sm:min-h-[140vh] flex items-start justify-center overflow-hidden"
    >
      {/* Background Carousel */}
          ...
          <CarouselContent className="h-full -ml-0">
            {heroImages.map((image, index) => (
              <CarouselItem key={index} className="h-full pl-0">
                <div className="relative w-full min-h-[160vh] sm:min-h-[140vh]">
                  <img
                    src={image.src}
                    alt={image.alt}
      ...
      <div className="container-custom relative z-20 pt-24 md:pt-28">
        <div className="max-w-4xl mx-auto text-center">
          ...
          {/* Stats */}
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 max-w-3xl mx-auto animate-fade-up animation-delay-400 mt-8">
